...
import com.oxycab.provider.common.chat.ChatActivity;
import com.oxycab.provider.data.network.model.Request_;
import com.oxycab.provider.data.network.model.UserGetResponse;
import com.oxycab.provider.ui.activity.main.MainActivity;
import com.oxycab.provider.ui.bottomsheetdialog.cancel.CancelDialogFragment;
...
public class StatusFlowFragment extends BaseFragment implements StatusFlowIView {
    ...
    private void showOTP() {
        ...
        final OtpView pinView = view.findViewById(R.id.pinView);
