package com.oxycab.provider.ui.activity.welcome;
...
import com.oxycab.provider.data.network.model.Walkthrough;
import com.oxycab.provider.ui.activity.email.EmailActivity;
import com.oxycab.provider.ui.activity.regsiter.RegisterActivity;
import com.oxycab.provider.ui.activity.sociallogin.SocialLoginActivity;
...
public class WelcomeActivity extends BaseActivity implements WelcomeIView, ViewPager.OnPageChangeListener {
    ...
    public void initView() {
        ...
        if (!hasPermission(Manifest.permission.ACCESS_FINE_LOCATION)) {
            requestPermissionsSafely(new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, ASK_MULTIPLE_PERMISSION_REQUEST_CODE);
        }
    }
